const navItems = [
  ...
  { name: 'Сортировка', id: 2, slug: '/sorting', type: 'link' },
  { name: 'Постановка', id: 2, slug: '/staging', type: 'link' },
  { name: 'Результаты', id: 2, slug: '/results', type: 'link' },
  {
    name: 'Справочники',
    id: 2,
    slug: '/handbook',
  ...
  { name: 'Утилиты', id: 2, slug: '/utilities', type: 'link' },
  { name: 'Контейнер', id: 2, slug: '/container', type: 'link' },
]
