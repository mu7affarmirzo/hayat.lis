...
import { useResultsTemplateTable } from '../../../../model/useResultsTemplateTable'

export const ResultsTemplateTableBody = () => {
  const { activeRow, handleClickRow } = useResultsTemplateTable()
