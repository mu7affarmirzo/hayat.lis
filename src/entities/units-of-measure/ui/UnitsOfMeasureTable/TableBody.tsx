...
import { useUnitsOfMeasureTable } from '../../model/useUnitsOfMeasureTable'

export const UnitsOfMeasureTableBody = () => {
  const { activeRow, handleClickRow } = useUnitsOfMeasureTable()
