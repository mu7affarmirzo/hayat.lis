...
import './../table.css'
import { ReagentTypesTableBody } from './TableBody'

interface ReagentTypesProps {
  packagesTableActions: ReactNode
}

export const ReagentTypesTable = (props: ReagentTypesProps) => {
  return (
    <Stack height={'calc(100vh - 132px)'} p={'5px'} width={'100%'}>
      ...
      >
        <Typography>Типы реагентов</Typography>
      </Box>
      <Box>
        <TableContainer
          sx={{
