...
import './../table.css'
import { TripodTypesTableBody } from './TableBody'

interface TripodTypesProps {
  packagesTableActions: ReactNode
}

export const TripodTypesTable = (props: TripodTypesProps) => {
  return (
    <Stack height={'calc(100vh - 132px)'} p={'5px'} width={'100%'}>
      ...
      >
        <Typography>Виды штативов</Typography>
      </Box>
      <Box>
        <TableContainer
          sx={{
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <TableCell className="bg-bgHoverGray">Тип</TableCell>
              </TableRow>
            </TableHead>
            <TripodTypesTableBody />
          </Table>
        </TableContainer>
      </Box>
      <Stack
