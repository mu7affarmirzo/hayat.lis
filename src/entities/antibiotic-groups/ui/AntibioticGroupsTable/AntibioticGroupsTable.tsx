...
import './../table.css'
import { AntibioticGroupsTableBody } from './TableBody'

interface AntibioticGroupsProps {
  packagesTableActions: ReactNode
}

export const AntibioticGroupsTable = (props: AntibioticGroupsProps) => {
  return (
    <Stack height={'calc(100vh - 132px)'} p={'5px'} width={'100%'}>
      ...
      >
        <Typography>Группы антибиотиков</Typography>
      </Box>
      <Box>
        <TableContainer
          sx={{
