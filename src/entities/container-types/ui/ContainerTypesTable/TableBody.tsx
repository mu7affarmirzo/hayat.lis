...
import { useContainerTypesTable } from '../../model/useContainerTypesTable'

export const ContainerTypesTableBody = () => {
  const { activeRow, handleClickRow } = useContainerTypesTable()
