...
import './../table.css'
import { BiomaterialTableBody } from './TableBody'

interface BiomaterialProps {
  packagesTableActions: ReactNode
}

export const BiomaterialTable = (props: BiomaterialProps) => {
  return (
    <Stack height={'calc(100vh - 132px)'} p={'5px'} width={'100%'}>
      ...
      >
        <Typography>Биоматериалы</Typography>
      </Box>
      <Box>
        <TableContainer
          sx={{
